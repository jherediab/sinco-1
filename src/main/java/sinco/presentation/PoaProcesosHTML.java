...
/*     */   private HTMLInputElement $element_CodigoProceso;
...
/*     */   private HTMLSelectElement $element_FtipoProceso;
/*     */   private HTMLLabelElement $element_LabelNombre;
/*     */   private HTMLSelectElement $element_LiderProceso;
/*     */   private HTMLElement $element_LiderProcesoEd;
...
/*     */   public static final String NAME_liderProceso = "liderProceso";
/*     */   public static final String NAME_tipoProceso = "tipoProceso";
/*     */   public static final String NAME_usuarioInsercion = "usuarioInsercion";
/*     */   public static final String NAME_usuarioModificacion = "usuarioModificacion";
/* 240 */   public static final Class XMLC_GENERATED_CLASS = PoaProcesosHTML.class;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   public static final String XMLC_SOURCE_FILE = "sinco/presentation/PoaProcesos.html";
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 272 */   public PoaProcesosHTML(boolean buildDOM) { this(StandardDocumentLoader.getInstance(), buildDOM); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   public PoaProcesosHTML(PoaProcesosHTML src) {
...
/*     */ 
/*     */   
/*     */   public PoaProcesosHTML(DocumentLoader loader, boolean buildDOM) {
...
/*     */ 
/*     */   
/* 311 */   public PoaProcesosHTML(DocumentLoader loader) { this(loader, true); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 331 */     return new PoaProcesosHTML(this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 419 */   public HTMLInputElement getElementCodigoProceso() { return this.$element_CodigoProceso; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 428 */   public HTMLElement getElementCodigoProcesoEd() { return this.$element_CodigoProcesoEd; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 437 */   public HTMLInputElement getElementCodigoProcesoKey() { return this.$element_CodigoProcesoKey; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 446 */   public HTMLInputElement getElementDescripcion() { return this.$element_Descripcion; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 455 */   public HTMLElement getElementDescripcionEd() { return this.$element_DescripcionEd; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 464 */   public HTMLTableSectionElement getElementDetalle() { return this.$element_Detalle; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 473 */   public HTMLDivElement getElementDivConsulta() { return this.$element_DivConsulta; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 482 */   public HTMLDivElement getElementDivCreacionRegistro() { return this.$element_DivCreacionRegistro; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 491 */   public HTMLDivElement getElementDivEdicion() { return this.$element_DivEdicion; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 518 */   public HTMLSelectElement getElementEstado() { return this.$element_Estado; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 527 */   public HTMLElement getElementEstadoEd() { return this.$element_EstadoEd; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 536 */   public HTMLInputElement getElementFdescripcion() { return this.$element_Fdescripcion; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 545 */   public HTMLInputElement getElementFechaInsercion() { return this.$element_FechaInsercion; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 554 */   public HTMLElement getElementFechaInsercionEd() { return this.$element_FechaInsercionEd; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 563 */   public HTMLInputElement getElementFechaModificacion() { return this.$element_FechaModificacion; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 572 */   public HTMLElement getElementFechaModificacionEd() { return this.$element_FechaModificacionEd; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 581 */   public HTMLSelectElement getElementFtipoProceso() { return this.$element_FtipoProceso; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 590 */   public HTMLLabelElement getElementLabelNombre() { return this.$element_LabelNombre; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 599 */   public HTMLSelectElement getElementLiderProceso() { return this.$element_LiderProceso; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 608 */   public HTMLElement getElementLiderProcesoEd() { return this.$element_LiderProcesoEd; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 617 */   public HTMLElement getElementNroRegistros() { return this.$element_NroRegistros; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 626 */   public HTMLSelectElement getElementTipoProceso() { return this.$element_TipoProceso; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 635 */   public HTMLElement getElementTipoProcesoEd() { return this.$element_TipoProcesoEd; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 689 */   public void setTextCodigoProcesoEd(String text) { doSetText(this.$element_CodigoProcesoEd, text); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 698 */   public void setTextDescripcionEd(String text) { doSetText(this.$element_DescripcionEd, text); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 752 */   public void setTextEstadoEd(String text) { doSetText(this.$element_EstadoEd, text); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 788 */   public void setTextLiderProcesoEd(String text) { doSetText(this.$element_LiderProcesoEd, text); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 806 */   public void setTextTipoProcesoEd(String text) { doSetText(this.$element_TipoProcesoEd, text); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 815 */   public void setTextUsuarioInsercionEd(String text) { doSetText(this.$element_UsuarioInsercionEd, text); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 824 */   public void setTextUsuarioModificacionEd(String text) { doSetText(this.$element_UsuarioModificacionEd, text); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 833 */     if (node.getNodeType() != 9)
/*     */     {
/* 835 */       throw new XMLCRuntimeException("Node must be a document node");
/*     */     }
/*     */ 
/*     */     
/* 839 */     Document doc = (Document)node;
/*     */ 
/*     */     
/*     */     try {
/* 843 */       Field[] fs = getClass().getDeclaredFields();
/*     */       
/* 845 */       int substStart = "$element_".length();
/*     */       
/* 847 */       for (int i = 0; i < fs.length; i++) {
/*     */         
/* 849 */         Field f = fs[i];
/*     */         
/* 851 */         if (f.getName().startsWith("$element_")) {
/*     */           
/* 853 */           String id = f.getName().substring(substStart);
/*     */           
/* 855 */           Node idNode = doc.getElementById(id);
/*     */           
/* 857 */           if (idNode == null) {
/*     */             
/* 859 */             id = id.substring(0, 1).toLowerCase() + id.substring(1);
/*     */             
/* 861 */             idNode = doc.getElementById(id);
/*     */           } 
/*     */ 
/*     */           
/* 865 */           if (idNode != null) f.set(this, idNode);
/*     */         
/*     */         } 
/*     */       } 
/* 869 */     } catch (Exception e) {
/*     */       
/* 871 */       throw new XMLCRuntimeException("Error reflecting on element access fields", e);
/*     */     } 
/*     */   }
/*     */ }


/* Location:              D:\Documents\ardulab\Clinica Chiquinquira\fuente\sinco.war!\WEB-INF\classes\sinco\presentation\PoaProcesosHTML.class
