...
/*     */ import sinco.presentation.PoaProveedores;
...
/*     */ 
/*     */ 
/*     */ public class PoaProveedores
/*     */   implements HttpPresentation
/*     */ {
/*     */   private PoaProveedoresHTML pagHTML;
/*     */   
...
/*     */     }
/*     */     
/*  53 */     this.pagHTML = (PoaProveedoresHTML)comms.xmlcFactory.create(PoaProveedoresHTML.class);
/*  54 */     permisos(comms);
/*     */     
...
/*  85 */     int codigoProveedor = 0;
/*     */     try {
/*  87 */       codigoProveedor = Integer.parseInt(comms.request.getParameter("codigoProveedor"));
/*     */     }
/*  89 */     catch (Exception e) {
/*  90 */       throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ValorNoValido&p1=codigoProveedor"));
/*     */     } 
/*     */     
/*  93 */     RespuestaBD rta = new RespuestaBD();
/*  94 */     if (_operacion.equals("E")) {
/*  95 */       PoaProveedoresDAO rs = new PoaProveedoresDAO();
...
/*     */       }
/*  99 */       rta = rs.eliminarRegistro(codigoProveedor);
/* 100 */       if (!rta.isRta()) {
/* 101 */         throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ErrorPoaProveedores&p1=" + rta.getMensaje()));
/*     */       }
/* 103 */       rs.close();
/* 104 */       String sPagina = "PoaProveedores.po?_operacion=X";
...
/* 116 */     PoaProveedoresDAO rs = new PoaProveedoresDAO();
...
/* 121 */       rta = rs.crearRegistro(codigoProveedor, descripcion, area, estado, elUsuario);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 127 */       codigoProveedor = rta.getSecuencia();
/*     */     } else {
/*     */       
/* 130 */       rta = rs.modificarRegistro(codigoProveedor, descripcion, area, estado, elUsuario);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 137 */     rs.close();
/* 138 */     if (!rta.isRta()) {
/* 139 */       throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ErrorPoaProveedores&p1=" + rta.getMensaje()));
/*     */     }
/*     */     
/* 142 */     String sPagina = "PoaProveedores.po?_operacion=P&codigoProveedor=" + codigoProveedor + "";
...
/* 154 */     int codigoProveedor = 0;
/*     */     try {
/* 156 */       codigoProveedor = Integer.parseInt(comms.request.getParameter("codigoProveedor"));
/*     */     }
/* 158 */     catch (Exception e) {}
/*     */ 
/*     */     
/* 161 */     PoaProveedoresDAO rs = new PoaProveedoresDAO();
...
/*     */     }
/* 165 */     PoaProveedoresDTO reg = rs.cargarRegistro(codigoProveedor);
/* 166 */     rs.close();
/* 167 */     if (reg != null) {
/* 168 */       this.pagHTML.getElementCodigoProveedor().setValue("" + reg.getCodigoProveedor());
...
/*     */ 
/*     */       
/* 181 */       this.pagHTML.getElementCodigoProveedor().setReadOnly(true);
/*     */     } 
...
/*     */     
/* 210 */     this.pagHTML.getElementCodigoProveedor().setReadOnly(true);
/* 211 */     this.pagHTML.getElementCodigoProveedor().setValue("0");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 250 */     PoaProveedoresDAO rs = new PoaProveedoresDAO();
...
/*     */     }
/* 254 */     Collection<PoaProveedoresDTO> arr = rs.cargarTodos(descripcion, area, estado);
/*     */ 
/*     */ 
/*     */     
/* 258 */     rs.close();
...
/* 260 */     int cuantas = 0;
/* 261 */     Iterator<PoaProveedoresDTO> iterator = arr.iterator();
/* 262 */     while (iterator.hasNext()) {
/* 263 */       PoaProveedoresDTO reg = (PoaProveedoresDTO)iterator.next();
/* 264 */       HTMLElement eltr = (HTMLElement)this.pagHTML.createElement("tr");
/* 265 */       eltr.appendChild(newtd("" + reg.getCodigoProveedor()));
/* 266 */       String url = "PoaProveedores.po?_operacion=V&codigoProveedor=" + reg.getCodigoProveedor() + "";
...
/* 287 */     int codigoProveedor = 0;
/*     */     try {
/* 289 */       codigoProveedor = Integer.parseInt(comms.request.getParameter("codigoProveedor"));
/*     */     }
/* 291 */     catch (Exception e) {}
/*     */ 
/*     */     
/* 294 */     PoaProveedoresDAO rs = new PoaProveedoresDAO();
...
/*     */     }
/* 298 */     PoaProveedoresDTO reg = rs.cargarRegistro(codigoProveedor);
/* 299 */     rs.close();
/* 300 */     if (reg != null) {
/* 301 */       this.pagHTML.setTextCodigoProveedorEd("" + reg.getCodigoProveedor());
...
/*     */       
/* 310 */       this.pagHTML.getElementCodigoProveedorKey().setValue("" + reg.getCodigoProveedor());
...
/* 327 */     boolean oPermisoAct = oVarios.tienePermiso(miGrupo, "Poa_PoaProveedoresAct");
/* 328 */     boolean oPermisoDel = oVarios.tienePermiso(miGrupo, "Poa_PoaProveedoresDel");
/* 329 */     if (!oPermisoAct) {
...
/* Location:              D:\Documents\ardulab\Clinica Chiquinquira\fuente\sinco.war!\WEB-INF\classes\sinco\presentation\PoaProveedores.class
