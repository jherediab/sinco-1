...
/*     */ import sinco.data.PoaObjetivosSubsistemaSigDAO;
/*     */ import sinco.data.SisMultiValoresDAO;
/*     */ import sinco.data.TGeneralDAO;
/*     */ import sinco.presentation.PoaObjetivosSubsistemaSig;
...
/*     */ 
/*     */ 
/*     */ public class PoaObjetivosSubsistemaSig
/*     */   implements HttpPresentation
/*     */ {
/*     */   private PoaObjetivosSubsistemaSigHTML pagHTML;
/*     */   
...
/*     */     }
/*     */     
/*  53 */     this.pagHTML = (PoaObjetivosSubsistemaSigHTML)comms.xmlcFactory.create(PoaObjetivosSubsistemaSigHTML.class);
/*  54 */     permisos(comms);
/*     */     
...
/*  85 */     int codigoObjetivoSubsistema = 0;
/*     */     try {
/*  87 */       codigoObjetivoSubsistema = Integer.parseInt(comms.request.getParameter("codigoObjetivoSubsistema"));
/*     */     }
/*  89 */     catch (Exception e) {
/*  90 */       throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ValorNoValido&p1=codigoObjetivoSubsistema"));
/*     */     } 
/*     */     
/*  93 */     RespuestaBD rta = new RespuestaBD();
/*  94 */     if (_operacion.equals("E")) {
/*  95 */       PoaObjetivosSubsistemaSigDAO rs = new PoaObjetivosSubsistemaSigDAO();
...
/*     */       }
/*  99 */       rta = rs.eliminarRegistro(codigoObjetivoSubsistema);
/* 100 */       if (!rta.isRta()) {
/* 101 */         throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ErrorPoaObjetivosSubsistemaSig&p1=" + rta.getMensaje()));
/*     */       }
/* 103 */       rs.close();
/* 104 */       String sPagina = "PoaObjetivosSubsistemaSig.po?_operacion=X";
...
/* 116 */     PoaObjetivosSubsistemaSigDAO rs = new PoaObjetivosSubsistemaSigDAO();
...
/* 121 */       rta = rs.crearRegistro(codigoObjetivoSubsistema, descripcion, area, estado, elUsuario);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 127 */       codigoObjetivoSubsistema = rta.getSecuencia();
/*     */     } else {
/*     */       
/* 130 */       rta = rs.modificarRegistro(codigoObjetivoSubsistema, descripcion, area, estado, elUsuario);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 137 */     rs.close();
/* 138 */     if (!rta.isRta()) {
/* 139 */       throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ErrorPoaObjetivosSubsistemaSig&p1=" + rta.getMensaje()));
/*     */     }
/*     */     
/* 142 */     String sPagina = "PoaObjetivosSubsistemaSig.po?_operacion=P&codigoObjetivoSubsistema=" + codigoObjetivoSubsistema + "";
...
/* 154 */     int codigoObjetivoSubsistema = 0;
/*     */     try {
/* 156 */       codigoObjetivoSubsistema = Integer.parseInt(comms.request.getParameter("codigoObjetivoSubsistema"));
/*     */     }
/* 158 */     catch (Exception e) {}
/*     */ 
/*     */     
/* 161 */     PoaObjetivosSubsistemaSigDAO rs = new PoaObjetivosSubsistemaSigDAO();
...
/*     */     }
/* 165 */     PoaObjetivosSubsistemaSigDTO reg = rs.cargarRegistro(codigoObjetivoSubsistema);
/* 166 */     rs.close();
/* 167 */     if (reg != null) {
/* 168 */       this.pagHTML.getElementCodigoObjetivoSubsistema().setValue("" + reg.getCodigoObjetivoSubsistema());
...
/*     */ 
/*     */       
/* 181 */       this.pagHTML.getElementCodigoObjetivoSubsistema().setReadOnly(true);
/*     */     } 
...
/*     */     
/* 210 */     this.pagHTML.getElementCodigoObjetivoSubsistema().setReadOnly(true);
/* 211 */     this.pagHTML.getElementCodigoObjetivoSubsistema().setValue("0");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 250 */     PoaObjetivosSubsistemaSigDAO rs = new PoaObjetivosSubsistemaSigDAO();
...
/*     */     }
/* 254 */     Collection<PoaObjetivosSubsistemaSigDTO> arr = rs.cargarTodos(descripcion, area, estado);
/*     */ 
/*     */ 
/*     */     
/* 258 */     rs.close();
...
/* 260 */     int cuantas = 0;
/* 261 */     Iterator<PoaObjetivosSubsistemaSigDTO> iterator = arr.iterator();
/* 262 */     while (iterator.hasNext()) {
/* 263 */       PoaObjetivosSubsistemaSigDTO reg = (PoaObjetivosSubsistemaSigDTO)iterator.next();
/* 264 */       HTMLElement eltr = (HTMLElement)this.pagHTML.createElement("tr");
/* 265 */       eltr.appendChild(newtd("" + reg.getCodigoObjetivoSubsistema()));
/* 266 */       String url = "PoaObjetivosSubsistemaSig.po?_operacion=V&codigoObjetivoSubsistema=" + reg.getCodigoObjetivoSubsistema() + "";
...
/* 287 */     int codigoObjetivoSubsistema = 0;
/*     */     try {
/* 289 */       codigoObjetivoSubsistema = Integer.parseInt(comms.request.getParameter("codigoObjetivoSubsistema"));
/*     */     }
/* 291 */     catch (Exception e) {}
/*     */ 
/*     */     
/* 294 */     PoaObjetivosSubsistemaSigDAO rs = new PoaObjetivosSubsistemaSigDAO();
...
/*     */     }
/* 298 */     PoaObjetivosSubsistemaSigDTO reg = rs.cargarRegistro(codigoObjetivoSubsistema);
/* 299 */     rs.close();
/* 300 */     if (reg != null) {
/* 301 */       this.pagHTML.setTextCodigoObjetivoSubsistemaEd("" + reg.getCodigoObjetivoSubsistema());
...
/*     */       
/* 310 */       this.pagHTML.getElementCodigoObjetivoSubsistemaKey().setValue("" + reg.getCodigoObjetivoSubsistema());
...
/* 327 */     boolean oPermisoAct = oVarios.tienePermiso(miGrupo, "Poa_PoaObjetivosSubsistemaSigAct");
/* 328 */     boolean oPermisoDel = oVarios.tienePermiso(miGrupo, "Poa_PoaObjetivosSubsistemaSigDel");
/* 329 */     if (!oPermisoAct) {
...
/* Location:              D:\Documents\ardulab\Clinica Chiquinquira\fuente\sinco.war!\WEB-INF\classes\sinco\presentation\PoaObjetivosSubsistemaSig.class
