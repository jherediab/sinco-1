...
/*     */ import sinco.presentation.PoaMediosVerificacion;
...
/*     */ 
/*     */ 
/*     */ public class PoaMediosVerificacion
/*     */   implements HttpPresentation
/*     */ {
/*     */   private PoaMediosVerificacionHTML pagHTML;
/*     */   
...
/*     */     }
/*     */     
/*  51 */     this.pagHTML = (PoaMediosVerificacionHTML)comms.xmlcFactory.create(PoaMediosVerificacionHTML.class);
/*  52 */     permisos(comms);
/*     */     
...
/*  83 */     int CODIGOMEDIOVERIFICACION = 0;
/*     */     try {
/*  85 */       CODIGOMEDIOVERIFICACION = Integer.parseInt(comms.request.getParameter("CODIGOMEDIOVERIFICACION"));
/*     */     }
/*  87 */     catch (Exception e) {
/*  88 */       throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ValorNoValido&p1=CODIGOMEDIOVERIFICACION"));
/*     */     } 
/*     */     
/*  91 */     RespuestaBD rta = new RespuestaBD();
/*  92 */     if (_operacion.equals("E")) {
/*  93 */       PoaMediosVerificacionDAO rs = new PoaMediosVerificacionDAO();
...
/*     */       }
/*  97 */       rta = rs.eliminarRegistro(CODIGOMEDIOVERIFICACION);
/*  98 */       if (!rta.isRta()) {
/*  99 */         throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ErrorPoaMediosVerificacion&p1=" + rta.getMensaje()));
/*     */       }
/* 101 */       rs.close();
/* 102 */       String sPagina = "PoaMediosVerificacion.po?_operacion=X";
...
/* 107 */     PoaMediosVerificacionDAO rs = new PoaMediosVerificacionDAO();
...
/* 112 */       rta = rs.crearRegistro(CODIGOMEDIOVERIFICACION, descripcion, estado, elUsuario);
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 117 */       CODIGOMEDIOVERIFICACION = rta.getSecuencia();
/*     */     } else {
/*     */       
/* 120 */       rta = rs.modificarRegistro(CODIGOMEDIOVERIFICACION, descripcion, estado, elUsuario);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 126 */     rs.close();
/* 127 */     if (!rta.isRta()) {
/* 128 */       throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ErrorPoaMediosVerificacion&p1=" + rta.getMensaje()));
/*     */     }
/*     */     
/* 131 */     String sPagina = "PoaMediosVerificacion.po?_operacion=P&CODIGOMEDIOVERIFICACION=" + CODIGOMEDIOVERIFICACION + "";
...
/* 143 */     int CODIGOMEDIOVERIFICACION = 0;
/*     */     try {
/* 145 */       CODIGOMEDIOVERIFICACION = Integer.parseInt(comms.request.getParameter("CODIGOMEDIOVERIFICACION"));
/*     */     }
/* 147 */     catch (Exception e) {}
/*     */ 
/*     */     
/* 150 */     PoaMediosVerificacionDAO rs = new PoaMediosVerificacionDAO();
...
/*     */     }
/* 154 */     PoaMediosVerificacionDTO reg = rs.cargarRegistro(CODIGOMEDIOVERIFICACION);
/* 155 */     rs.close();
/* 156 */     if (reg != null) {
/* 157 */       this.pagHTML.getElementCODIGOMEDIOVERIFICACION().setValue("" + reg.getCODIGOMEDIOVERIFICACION());
...
/*     */ 
/*     */       
/* 167 */       this.pagHTML.getElementCODIGOMEDIOVERIFICACION().setReadOnly(true);
/*     */     } 
...
/*     */     
/* 193 */     this.pagHTML.getElementCODIGOMEDIOVERIFICACION().setReadOnly(true);
/* 194 */     this.pagHTML.getElementCODIGOMEDIOVERIFICACION().setValue("0");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 223 */     PoaMediosVerificacionDAO rs = new PoaMediosVerificacionDAO();
...
/*     */     }
/* 227 */     Collection<PoaMediosVerificacionDTO> arr = rs.cargarTodos(descripcion, estado);
/*     */ 
/*     */     
/* 230 */     rs.close();
/* 231 */     HTMLTableSectionElement hte = this.pagHTML.getElementDetalle();
/* 232 */     int cuantas = 0;
/* 233 */     Iterator<PoaMediosVerificacionDTO> iterator = arr.iterator();
/* 234 */     while (iterator.hasNext()) {
/* 235 */       PoaMediosVerificacionDTO reg = (PoaMediosVerificacionDTO)iterator.next();
/* 236 */       HTMLElement eltr = (HTMLElement)this.pagHTML.createElement("tr");
/* 237 */       eltr.appendChild(newtd("" + reg.getCODIGOMEDIOVERIFICACION()));
/* 238 */       String url = "PoaMediosVerificacion.po?_operacion=V&CODIGOMEDIOVERIFICACION=" + reg.getCODIGOMEDIOVERIFICACION() + "";
...
/* 258 */     int CODIGOMEDIOVERIFICACION = 0;
/*     */     try {
/* 260 */       CODIGOMEDIOVERIFICACION = Integer.parseInt(comms.request.getParameter("CODIGOMEDIOVERIFICACION"));
/*     */     }
/* 262 */     catch (Exception e) {}
/*     */ 
/*     */     
/* 265 */     PoaMediosVerificacionDAO rs = new PoaMediosVerificacionDAO();
...
/*     */     }
/* 269 */     PoaMediosVerificacionDTO reg = rs.cargarRegistro(CODIGOMEDIOVERIFICACION);
/* 270 */     rs.close();
/* 271 */     if (reg != null) {
/* 272 */       this.pagHTML.setTextCODIGOMEDIOVERIFICACIONEd("" + reg.getCODIGOMEDIOVERIFICACION());
...
/*     */       
/* 280 */       this.pagHTML.getElementCODIGOMEDIOVERIFICACIONKey().setValue("" + reg.getCODIGOMEDIOVERIFICACION());
...
/* 297 */     boolean oPermisoAct = oVarios.tienePermiso(miGrupo, "Poa_PoaMediosVerificacionAct");
/* 298 */     boolean oPermisoDel = oVarios.tienePermiso(miGrupo, "Poa_PoaMediosVerificacionDel");
/* 299 */     if (!oPermisoAct) {
...
/* Location:              D:\Documents\ardulab\Clinica Chiquinquira\fuente\sinco.war!\WEB-INF\classes\sinco\presentation\PoaMediosVerificacion.class
