...
/*     */ import sinco.presentation.PoaMetasPlanDesarrollo;
/*     */ import sinco.presentation.PoaMetasPlanDesarrolloHTML;
...
/*     */ 
/*     */ 
/*     */ public class PoaMetasPlanDesarrollo
/*     */   implements HttpPresentation
/*     */ {
/*     */   private PoaMetasPlanDesarrolloHTML pagHTML;
/*     */   
...
/*     */     }
/*     */     
/*  53 */     this.pagHTML = (PoaMetasPlanDesarrolloHTML)comms.xmlcFactory.create(PoaMetasPlanDesarrolloHTML.class);
/*  54 */     permisos(comms);
/*     */     
...
/*  85 */     int codigoMetaPlan = 0;
/*     */     try {
/*  87 */       codigoMetaPlan = Integer.parseInt(comms.request.getParameter("codigoMetaPlan"));
/*     */     }
/*  89 */     catch (Exception e) {
/*  90 */       throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ValorNoValido&p1=codigoMetaPlan"));
/*     */     } 
/*     */     
/*  93 */     RespuestaBD rta = new RespuestaBD();
/*  94 */     if (_operacion.equals("E")) {
/*  95 */       PoaMetasPlanDesarrolloDAO rs = new PoaMetasPlanDesarrolloDAO();
...
/*     */       }
/*  99 */       rta = rs.eliminarRegistro(codigoMetaPlan);
/* 100 */       if (!rta.isRta()) {
/* 101 */         throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ErrorPoaMetasPlanDesarrollo&p1=" + rta.getMensaje()));
/*     */       }
/* 103 */       rs.close();
/* 104 */       String sPagina = "PoaMetasPlanDesarrollo.po?_operacion=X";
...
/* 116 */     PoaMetasPlanDesarrolloDAO rs = new PoaMetasPlanDesarrolloDAO();
...
/* 121 */       rta = rs.crearRegistro(codigoMetaPlan, descripcion, area, estado, elUsuario);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 127 */       codigoMetaPlan = rta.getSecuencia();
/*     */     } else {
/*     */       
/* 130 */       rta = rs.modificarRegistro(codigoMetaPlan, descripcion, area, estado, elUsuario);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 137 */     rs.close();
/* 138 */     if (!rta.isRta()) {
/* 139 */       throw new ClientPageRedirectException(comms.request.getAppFileURIPath("Mensaje.po?codigo=ErrorPoaMetasPlanDesarrollo&p1=" + rta.getMensaje()));
/*     */     }
/*     */     
/* 142 */     String sPagina = "PoaMetasPlanDesarrollo.po?_operacion=P&codigoMetaPlan=" + codigoMetaPlan + "";
...
/* 154 */     int codigoMetaPlan = 0;
/*     */     try {
/* 156 */       codigoMetaPlan = Integer.parseInt(comms.request.getParameter("codigoMetaPlan"));
/*     */     }
/* 158 */     catch (Exception e) {}
/*     */ 
/*     */     
/* 161 */     PoaMetasPlanDesarrolloDAO rs = new PoaMetasPlanDesarrolloDAO();
...
/*     */     }
/* 165 */     PoaMetasPlanDesarrolloDTO reg = rs.cargarRegistro(codigoMetaPlan);
/* 166 */     rs.close();
/* 167 */     if (reg != null) {
/* 168 */       this.pagHTML.getElementCodigoMetaPlan().setValue("" + reg.getCodigoMetaPlan());
...
/*     */ 
/*     */       
/* 181 */       this.pagHTML.getElementCodigoMetaPlan().setReadOnly(true);
/*     */     } 
...
/*     */     
/* 210 */     this.pagHTML.getElementCodigoMetaPlan().setReadOnly(true);
/* 211 */     this.pagHTML.getElementCodigoMetaPlan().setValue("0");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 250 */     PoaMetasPlanDesarrolloDAO rs = new PoaMetasPlanDesarrolloDAO();
...
/*     */     }
/* 254 */     Collection<PoaMetasPlanDesarrolloDTO> arr = rs.cargarTodos(descripcion, area, estado);
/*     */ 
/*     */ 
/*     */     
/* 258 */     rs.close();
...
/* 260 */     int cuantas = 0;
/* 261 */     Iterator<PoaMetasPlanDesarrolloDTO> iterator = arr.iterator();
/* 262 */     while (iterator.hasNext()) {
/* 263 */       PoaMetasPlanDesarrolloDTO reg = (PoaMetasPlanDesarrolloDTO)iterator.next();
/* 264 */       HTMLElement eltr = (HTMLElement)this.pagHTML.createElement("tr");
/* 265 */       eltr.appendChild(newtd("" + reg.getCodigoMetaPlan()));
/* 266 */       String url = "PoaMetasPlanDesarrollo.po?_operacion=V&codigoMetaPlan=" + reg.getCodigoMetaPlan() + "";
...
/* 287 */     int codigoMetaPlan = 0;
/*     */     try {
/* 289 */       codigoMetaPlan = Integer.parseInt(comms.request.getParameter("codigoMetaPlan"));
/*     */     }
/* 291 */     catch (Exception e) {}
/*     */ 
/*     */     
/* 294 */     PoaMetasPlanDesarrolloDAO rs = new PoaMetasPlanDesarrolloDAO();
...
/*     */     }
/* 298 */     PoaMetasPlanDesarrolloDTO reg = rs.cargarRegistro(codigoMetaPlan);
/* 299 */     rs.close();
/* 300 */     if (reg != null) {
/* 301 */       this.pagHTML.setTextCodigoMetaPlanEd("" + reg.getCodigoMetaPlan());
...
/*     */       
/* 310 */       this.pagHTML.getElementCodigoMetaPlanKey().setValue("" + reg.getCodigoMetaPlan());
...
/* 327 */     boolean oPermisoAct = oVarios.tienePermiso(miGrupo, "Poa_PoaMetasPlanDesarrolloAct");
/* 328 */     boolean oPermisoDel = oVarios.tienePermiso(miGrupo, "Poa_PoaMetasPlanDesarrolloDel");
/* 329 */     if (!oPermisoAct) {
...
/* Location:              D:\Documents\ardulab\Clinica Chiquinquira\fuente\sinco.war!\WEB-INF\classes\sinco\presentation\PoaMetasPlanDesarrollo.class
